...
//    [self setTitle:NSLocalizedString(MJ_PULLUP, nil) forState:MJRefreshStateIdle];
//    [self setTitle:NSLocalizedString(MJ_RELEASE_LOAD, nil) forState:MJRefreshStatePulling];
//    [self setTitle:NSLocalizedString(MJ_LOADING, nil) forState:MJRefreshStateRefreshing];
//    [self setTitle:NSLocalizedString(MJ_LOADEDALL, nil) forState:MJRefreshStateNoMoreData];
}
